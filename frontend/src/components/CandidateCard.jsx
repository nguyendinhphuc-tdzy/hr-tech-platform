...
// Thêm prop 'onClick' vào đây
const CandidateCard = ({ data, onClick }) => {
  
  // ... (Hàm getTagClass giữ nguyên) ...
  ...
  return (
    <div 
        ...
        onClick={onClick} // <--- GẮN SỰ KIỆN CLICK VÀO ĐÂY
        style={{cursor: 'pointer', transition: 'transform 0.2s'}} // Thêm style con trỏ
    >
